    ...
    <section id="features" className="bg-[#f4f6fa] pb-16 pt-12 sm:pb-20 sm:pt-12">
      <div className="mx-auto grid max-w-[1180px] items-center gap-14 px-5 lg:grid-cols-[.8fr_1.2fr] lg:gap-20">
        <div>
          ...
          <ArrowLink href="/dashboard">Analyze your first document</ArrowLink>
        </div>
        <div data-reveal className="reveal-on-scroll reveal-from-right dashboard-shell rounded-[20px] bg-white p-2">
          <div className="rounded-[14px] bg-[#f8f9fc] p-4 sm:p-6">
            ...
            <div className="mt-4 inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-[10px] bg-[#245eea] px-4 text-sm font-semibold text-white shadow-[0_6px_16px_-8px_rgba(37,99,235,.7)]"><ListChecks className="size-4" /> Create checklist</div>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="mx-auto grid max-w-[1180px] items-center gap-14 px-5 lg:grid-cols-[.9fr_1.1fr] lg:gap-20">
        ...
        <div className="rounded-[20px] bg-white/[.055] p-2 shadow-[inset_0_0_0_1px_rgba(255,255,255,.1),0_28px_70px_-30px_rgba(0,0,0,.65)]">
          <div className="rounded-[14px] bg-[#f8f9fc] p-5 text-[#111a2e] sm:p-7">
            <div className="flex items-center justify-between"><div><p className="text-[10px] font-medium text-[#858d9a]">Upcoming</p><h3 className="mt-1 text-xl font-semibold tracking-[-.04em]">Deadlines</h3></div><span aria-hidden="true" className="flex size-10 items-center justify-center rounded-[9px] bg-white text-[#667080] shadow-[0_0_0_1px_rgba(15,23,42,.07)]"><Search className="size-4" /></span></div>
        ...
        <div data-reveal className="reveal-on-scroll reveal-scale dashboard-shell mx-auto mt-14 max-w-4xl rounded-[20px] bg-white p-2">
          <div className="overflow-hidden rounded-[14px] bg-[#f7f9fc]">
            ...
            <div className="copilot-sequence mx-auto max-w-2xl space-y-5 p-4 sm:p-8">
              ...
              <div className="copilot-suggestion ml-11 inline-flex min-h-10 items-center gap-2 rounded-[9px] bg-[#edf3ff] px-3 text-[11px] font-semibold text-[#3e64be]"><Bell className="size-3.5" /> Create reminders for all deadlines</div>
            </div>
            <div className="border-t border-black/[.06] bg-white p-3 sm:p-4"><div className="mx-auto flex max-w-2xl items-center gap-2 rounded-[11px] bg-[#f7f8fa] p-1.5 pl-4 shadow-[inset_0_0_0_1px_rgba(15,23,42,.08)]"><Paperclip className="size-4 text-[#7d8694]" /><span className="min-w-0 flex-1 truncate text-xs text-[#9299a4]">Ask about your paperwork...</span><span aria-hidden="true" className="flex size-9 shrink-0 items-center justify-center rounded-[9px] bg-[#245eea] text-white"><Send className="size-4" /></span></div></div>
          </div>
        </div>
      </div>
    </section>
